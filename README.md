# Angular Boot Camp example: signals-primitives
...
**[StackBlitz for signals-primitives](https://stackblitz.io/github/AngularBootCamp/signals-primitives)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/signals-primitives.git
cd signals-primitives
npm install
npm start
```
